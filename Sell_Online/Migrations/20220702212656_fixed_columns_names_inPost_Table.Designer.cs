...
namespace Sell_Online.Migrations
{
    ...
    [Migration("20220702212656_fixed_columns_names_inPost_Table")]
    partial class fixed_columns_names_inPost_Table
    {
            ...
            modelBuilder.Entity("Sell_Online.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime?>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 7, 2, 23, 26, 56, 521, DateTimeKind.Local).AddTicks(6115));

                    b.Property<DateTime?>("EditDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 7, 2, 23, 26, 56, 522, DateTimeKind.Local).AddTicks(2933));
                    ...
                    b.Property<DateTime?>("SoldDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 7, 2, 23, 26, 56, 522, DateTimeKind.Local).AddTicks(3043));
